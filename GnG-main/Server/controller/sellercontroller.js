...
try{
  ...
  const exist =await sellermodel.find({email})
  if(exist){
  ...
  return res.json({success:true,token,message:"registered succesfuly"})
 }
catch(e){
   console.log(e)
...
export const productlist=async(req,res)=>{
  ...
  const products=await addproductmodel.find({category:categoryname});
