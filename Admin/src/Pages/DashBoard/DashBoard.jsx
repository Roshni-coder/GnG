...
function DashBoard() {
  ...
  return (
    <>
     <div className="!w-full !bg-white !px-10 py-2  flex items-center gap-8 mb-5 justify-between rounded-md">
      <div className="info">
        <h1 className=' text-[35px] font-bold leading-10 mb-3'>Welcome To GiftnGifts </h1>
        <p>Here's What happening on your store todyday. See the statistics at once.</p>
        <br />
        <Button className='btn-blue '><FiPlus className='!pr-2 text-[22px]' />Add Product</Button>
        </div>
        ...
        <div className="orders my-4 shadow-md rounded-md py-4 !px-5 bg-white">
          <div className="flex items-center justify-between ">
            <h2 className="text-[18px] pl-1 font-[600]">
            Products 
            </h2>
          </div>
