...
function DashBoard() {
  ...
  return (
    <>
      <div className="!w-full !bg-white !px-10 py-2  flex items-center gap-8 mb-3 justify-between rounded-md">
        <div className="info">
      ...
      <DashBordBox />
      <div className="orders my-3 shadow-md rounded-md py-4 !px-5 bg-white">
        <div className="flex items-center py-1 justify-between ">
          <h2 className="text-[18px] pl-1 font-[600]">Products</h2>
          <Button className="btn-blue ">
            <FiPlus className="!pr-1 text-[22px]" />
            Add Product
          </Button>
        ...
        <div className="relative pb-5 overflow-auto max-h-[450px] mt-5 ">
          <table className="w-full text-sm  text-center  text-gray-500 dark:text-gray-500">
            ...
            <tbody className="">
              <tr className="border-b border-gray-200">
                ...
                <td className="sales pl-8 py-2 cursor-pointer">
                ...
                <td className="px-6 py-2 cursor-pointer">
                  <Tooltip title="Edit Product" placement="bottom">
                    <Button className="!w-[35px] rounded-full hover:!bg-[#f1f1f1] !h-[35px] !min-w-[35px] bg-[#f1f1f1]">
                      <MdOutlineEdit className="!text-[20px] text-[rgba(0,0,0,0.8)] " />
                    </Button>
                  </Tooltip>
                  <Tooltip title="View Product" placement="bottom">
      ...
      <div className="orders my-4 shadow-md rounded-md py-4 !px-5 bg-white">
